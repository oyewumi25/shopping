...
const { Search } = Input;
  ...
  const Appbar = () => {
    ...
    src={couverture}
    width={"50%"}
    style={{width:"100vh",marginLeft:30,marginRight:30}}
...
<div className="site-card-wrapper" style={{marginTop:"3%",margin:"6%"}}>
 ...
 <Input placeholder="12000F" style={{marginTop:"5%",width:"20%",marginLeft:"-5%"}} />
  ...
  <div className="site-card-wrapper">
    <Row gutter={16}>
      <Col span={8}>
      <LockOutlined style={{width:"105vh",color:"#191970"}}/>
      ...
      <Col span={8}>
      <CarOutlined style={{width:"53vh",color:"#00BFFF",color:"#191970"}}/>
      ...
      <Col span={8}>
      <SyncOutlined style={{width:"1vh",color:"#191970"}}/>
